...
#
# Features:
# - Automatic Java detection and installation (no root access required)
...
# - Steam Deck optimized Java installation via install-jdk-on-steam-deck
#
...
# Java configuration
# JAVA_PATH: Full path to Java executable (automatically selected based on Minecraft version)
JAVA_PATH=""
